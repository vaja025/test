...
Public Class LodgeSelection

    Property LodgeName As String
        Get
            Return txtName.Text
        End Get
    ...
    Public Property DataSource() As List(Of Lodge)
        Get
            Return gvData.DataSource
        End Get
        Set(ByVal value As List(Of Lodge))
            gvData.DataSource = New SortableBindingList(Of Lodge)(value)
        End Set
    End Property

    Public ReadOnly Property DataItem As Lodge
        Get
    ...
    Private Sub TextHasChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtName.KeyUp, txtNumber.KeyUp, txtProvince.KeyUp

        gvData.DataSource = LodgeItem.Search(txtName.Text, txtNumber.Text, txtProvince.Text, False)
